...
for j in range(len(feats)):
    ...
    pathh1 = r"H:\科研1\E02E03w\激发态E_2_2+\rms随比例变化\合并数据/"
    pathh2 = r"H:\科研1\E02E03w\激发态E_2_2+\rms随比例变化\训练数据/"
    pathh3 = r"H:\科研1\E02E03w\激发态E_2_2+\rms随比例变化\剩余数据/"
    pathh4 = r"H:\科研1\E02E03w\激发态E_2_2+\rms随比例变化\外推数据/"
